...
用法:
  python step6_3_phase_transition_analysis.py                    # 分析默认体系
  python step6_3_phase_transition_analysis.py --all              # 分析所有可用体系
  python step6_3_phase_transition_analysis.py --add Pt6sn0 Pt7sn5  # 添加额外体系
  python step6_3_phase_transition_analysis.py --only Air68 Pt8sn6  # 只分析指定体系
  python step6_3_phase_transition_analysis.py --list             # 列出所有可用体系
